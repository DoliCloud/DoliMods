...
$sql = "SELECT s.rowid as socid, s.name, s.firstname, sum(f.total_ht) as amount, sum(f.total_ttc) as amount_ttc";
...
if ($result)
{
	...
	while ($i < $num)
	{
		...
		$name[$obj->socid] = $obj->firstname.' '.$obj->name;
