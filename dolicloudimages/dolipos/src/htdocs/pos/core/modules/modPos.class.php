...
class modPos extends DolibarrModules
{
	...
	function modPos($DB)
	{
		...
		$this->const[$r][2] = "mod_ticket_avenc";
		...
		*/
		...
		// Example to declare a Left Menu entry:
		 $this->menu[$r]=array(	'fk_menu'=>'r=0',		// Use r=value where r is index key used for the parent menu entry (higher parent must be a top menu entry)
									...
									'langs'=>'pos@pos',	// Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
									'position'=>100,
									'enabled'=>'$conf->global->POS_USE_TICKETS',			// Define condition to show or hide menu entry. Use '$conf->mymodule->enabled' if entry must be visible if module is enabled.
		...
		//
		// Example to declare another Left Menu entry:
		$this->menu[$r]=array(	'fk_menu'=>'r=27',		// Use r=value where r is index key used for the parent menu entry (higher parent must be a top menu entry)
									'type'=>'left',			// This is a Left menu entry
									'titre'=>'Tickets',
									'mainmenu'=>'@pos',
		...
		$this->menu[$r]=array(	'fk_menu'=>'r=27',		// Use r=value where r is index key used for the parent menu entry (higher parent must be a top menu entry)
									...
									'langs'=>'main',	// Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
									'position'=>102,
									'enabled'=>'$conf->global->POS_USE_TICKETS && $conf->global->POS_PLACES',			// Define condition to show or hide menu entry. Use '$conf->mymodule->enabled' if entry must be visible if module is enabled.
									'perms'=>'$user->rights->pos->stats',			// Use 'perms'=>'$user->rights->mymodule->level1->level2' if you want your menu with a permission rules
									'target'=>'',
									'user'=>0);				// 0
		...
		// Example to declare another Left Menu entry:
		 ...
		 //
		 // Example to declare another Left Menu entry:
		 $this->menu[$r]=array(	'fk_menu'=>'r=34',		// Use r=value where r is index key used for the parent menu entry (higher parent must be a top menu entry)
							 		'type'=>'left',			// This is a Left menu entry
							 		'titre'=>'Factures',
							 		'mainmenu'=>'@pos',
