...
YouWillInstallDoliWamp=Va a instalar o actualizar DoliMed (Apache+Mysql+PHP+Dolibarr+Medical module) en su ordenador.
...
DoliWampWillStartApacheMysql=El instalador DoliMed intentará iniciar o reiniciar Apache y MySQL, esto puede durar desde varios segundos a un minuto después de la confirmación. ¿Iniciar la instalación o actualización de los servidores Web y bases de datos requeridas por Dolibarr?
