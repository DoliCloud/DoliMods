...
0 21 * * * /Applications/MAMP/Library/bin/mysqldump -h localhost -uroot -pmypassword dolimed > /Applications/MAMP/dolibarr_documents/admin/backup/mysqldump_dolimed_auto_`date +%d`.sql
