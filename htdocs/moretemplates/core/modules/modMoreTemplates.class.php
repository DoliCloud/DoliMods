...
/**
 *       \file       htdocs/moretemplates/core/modules/modMoreTemplates.class.php
 *       \ingroup    ftp
 *       \brief      Description and activation file for module moretemplates
 */
...
/**
 *	Description and activation class for module moretemplates
 */
class modMoreTemplates extends DolibarrModules
{
	/**
	...
	function __construct($db)
	{
		...
		$this->config_page_url = array('moretemplates.php@moretemplates');
		...
		$this->langfiles = array("moretemplates@moretemplates");
		...
		// Permissions
		$this->rights_class = 'moretemplates';	// Permission key
