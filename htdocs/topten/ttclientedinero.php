 ...
 */
 ...
 $listatoptenclientes=$TOPT->TTClienteDinero($tipotopten,$datos);
 }
...
print_fiche_titre('<a href="'.DOL_URL_ROOT.'/topten/index.php">'.$langs->trans("TTtopten").'</a> -> '.$langs->trans("TTCliente").' '.$langs->trans("TTClienteDinero"));
