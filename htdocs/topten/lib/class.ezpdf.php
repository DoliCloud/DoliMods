...
function ezImage($image,$pad = 5,$width = 0,$resize = 'full',$just = 'center',$border = '',$alto = NULL,$ancho = NULL,$posx = NULL,$posy = NULL){
	...
	if ($type == "jpeg"){
		if($alto != NULL && $ancho != NULL && $posx != NULL && $posy != NULL)
		{$this->addJpegFromFile($image,$posx,$posy,$ancho,$alto);}
		else
	...
	if ($type == "png"){
		if($alto != NULL && $ancho != NULL && $posx != NULL && $posy != NULL)
		{$this->addPngFromFile($image,$posx,$posy,$ancho,$alto);}
		else
