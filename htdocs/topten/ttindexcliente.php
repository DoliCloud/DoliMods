...
print '<a href="'.DOL_URL_ROOT.'/topten/ttclientedinero.php">'.$langs->trans("TTClienteDinero").'</a>';
print '<br>';

print "<br>";
//print '<hr style="color: #DDDDDD;">';
print img_picto('','puce').' '.$langs->trans("TTMENSMEJORCLIENTEFACTURAS")."<br>";
print '<a href="'.DOL_URL_ROOT.'/topten/ttclientefactura.php">'.$langs->trans("TTClienteFactura").'</a>';
print "<br>";
print '<br>';
