...
/*   Copyright (C) 2012 Alexis José Turruella Sánchez
	 ...
	 Fichero ttproductocantidad.php
 */
$res=0;
...
$TOPT=new TOPTEN($db);
 ...
 $listatoptenproductos=$TOPT->TTProductoCantidadVendida($tipotopten,$datos);
 }
...
print_fiche_titre('<a href="'.DOL_URL_ROOT.'/topten/index.php">'.$langs->trans("TTtopten").'</a> -> '.$langs->trans("TTProducto").' '.$langs->trans("TTProductoCantidad"));
...
print $langs->trans("TTtopten");
   print '<table width="100%" class="noborder" border="0" cellspacing="0" cellpadding="0">';
 	print ' <tr class="liste_titre">';
		...
		print '<td width="18%">'.$langs->trans("TTCantidadVendida").'</td>';
