...
$TOPT=new TOPTEN($db);
 ...
 $listatoptenfacturas=$TOPT->TTFacturaTotalProductosUnidades($tipotopten,$datos);
 }
...
print_fiche_titre('<a href="'.DOL_URL_ROOT.'/topten/index.php">'.$langs->trans("TTtopten").'</a> -> '.$langs->trans("TTFactura").' '.$langs->trans("TTFacturaProducto"));
...
print $langs->trans("TTtopten");
   print '<table width="100%" class="noborder" border="0" cellspacing="0" cellpadding="0">';
 	print ' <tr class="liste_titre">';
		...
		print '<td width="18%">'.$langs->trans("TTCANTPRODUCTO").'</td>';
	 ...
	 print "<tr $bc[$var]>";
		...
		print '<td >'.($listatoptenfacturas[$i][0]->suma_productos).'</td>';
		print '<td >';
