...
/**
 *      \defgroup   numberingpack     Module NumberingPack
 *      \brief      Module to add numbering rules
 */

/**
 *       \file       htdocs/numberworkds/core/modules/modNumberingPack.class.php
 *       \ingroup    numberingpack
 *       \brief      Fichier de description et activation du module NumberingPack
 */
include_once(DOL_DOCUMENT_ROOT ."/core/modules/DolibarrModules.class.php");

/**
 *	Class to describe and activate module NumberingPack
 */
class modNumberingPack extends DolibarrModules
{
	...
	function __construct($db)
	{
		...
		$this->rights_class = 'numberingpack';
