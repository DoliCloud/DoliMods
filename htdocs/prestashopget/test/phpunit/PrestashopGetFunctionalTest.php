...
/**
 * \file    test/functional/PrestashopGetFunctionalTest.php
...
/**
 * Class PrestashopGetFunctionalTest
 *
 ...
 *
 * @package Testprestashopget
 */
class PrestashopGetFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modPrestashopGet')->click();
		} else {
			// Disable the module
			$this->byHref('modPrestashopGet')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/prestashopget/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('prestashopget/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/prestashopget/admin/about.php');
		$this->authenticate();
		return $this->assertContains('prestashopget/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('prestashopgetwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modPrestashopGet_PrestashopGetTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modPrestashopGet_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
