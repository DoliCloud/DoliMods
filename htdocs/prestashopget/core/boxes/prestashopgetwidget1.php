...
/**
 * \file    modulebuilder/template/core/boxes/prestashopgetwidget1.php
 * \ingroup prestashopget
 * \brief   Widget provided by PrestashopGet
 *
 ...
 */
class prestashopgetwidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "prestashopgetbox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "prestashopget@prestashopget";
	 ...
	 */
	public $depends = array('prestashopget');
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		//$this->hidden = ! ($user->rights->prestashopget->myobject->read);   // Condition when module is visible by user (test on permission)
	}
	...
	public function loadBox($max = 5)
	{
		...
		//include_once DOL_DOCUMENT_ROOT . "/prestashopget/class/prestashopget.class.php";

		// Populate the head at runtime
		$text = $langs->trans("PrestashopGetBoxDescription", $max);
		$this->info_box_head = array(
			...
			'subpicto' => 'object_prestashopget@prestashopget',
