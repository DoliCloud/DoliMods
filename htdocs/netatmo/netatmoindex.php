...
/**
 *	\file       netatmo/netatmoindex.php
 *	\ingroup    netatmo
 *	\brief      Home page of netatmo top menu
 */
...
$langs->loadLangs(array("netatmo@netatmo"));
...
llxHeader("", $langs->trans("NetatmoArea"));

print load_fiche_titre($langs->trans("NetatmoArea"), '', 'netatmo.png@netatmo');
...
if (! empty($conf->netatmo->enabled) && $user->rights->netatmo->read)
{
