...
/**
 * \file    test/functional/NetatmoFunctionalTest.php
 * \ingroup netatmo
 ...
 * @package Testnetatmo
 */
class NetatmoFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/netatmo/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('netatmo/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/netatmo/admin/about.php');
		$this->authenticate();
		return $this->assertContains('netatmo/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('netatmowidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modNetatmo_NetatmoTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modNetatmo_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
