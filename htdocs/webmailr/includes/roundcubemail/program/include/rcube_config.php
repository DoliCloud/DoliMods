...
/*
 ...
 $Id: rcube_config.php,v 1.1 2011/08/01 19:22:12 eldy Exp $
...
class rcube_config
{
	...
	private function load_host_config()
	{
		...
		} elseif (!empty($this->prop['include_host_config'])) {
	...
	public function mail_domain($host)
	{
		...
		} elseif (!empty($this->prop['mail_domain']))
