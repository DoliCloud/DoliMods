...
/*
 ...
 $Id: rcube_mdb2.php,v 1.1 2011/08/01 19:22:12 eldy Exp $
...
class rcube_mdb2
{
	...
	private function dsn_connect($dsn)
	{
		...
		} elseif ($this->db_provider == 'sqlite') {
			$dsn_array = MDB2::parseDSN($dsn);
			if (!filesize($dsn_array['database']) && !empty($this->sqlite_initials))
				$this->_sqlite_create_database($dbh, $this->sqlite_initials);
		} elseif ($this->db_provider!='mssql' && $this->db_provider!='sqlsrv')
			$dbh->setCharset('utf8');
