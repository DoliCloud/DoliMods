...
if (! $user->hasRight('facturx', 'read')) accessforbidden();
...
llxHeader("", $langs->trans("FacturXArea"));

print load_fiche_titre($langs->trans("FacturXArea"), '', 'facturx.png@facturx');
...
if (! empty($conf->facturx->enabled) && $user->rights->facturx->read)
{
