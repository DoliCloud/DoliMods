...
--ALTER TABLE llx_discussion_channel ADD UNIQUE INDEX uk_discussion_channel_fieldxy(fieldx, fieldy);

--ALTER TABLE llx_discussion_channel ADD CONSTRAINT llx_discussion_channel_fk_field FOREIGN KEY (fk_field) REFERENCES llx_discussion_myotherobject(rowid);
