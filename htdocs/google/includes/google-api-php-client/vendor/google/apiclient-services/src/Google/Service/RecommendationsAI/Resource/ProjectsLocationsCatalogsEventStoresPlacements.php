...
class Google_Service_RecommendationsAI_Resource_ProjectsLocationsCatalogsEventStoresPlacements extends Google_Service_Resource
{
	 ...
	 *                     identify the set of models that will be used to make the prediction.
	 *
	 ...
	 *                     specified `CatalogItem`. Typically used on product detail   pages. For
	 *                     example - More items like this.
	 *
	 *                     * `recently_viewed_default`: Returns up to 75 items recently viewed by the
	 *                     specified `userId` or `visitorId`, most recent ones first. Returns   nothing
	 *                     if neither of them has viewed any items yet. For example -   Recently viewed.
	 *
	 *                     The full list of available placements can be seen at https://console.cloud.go
	 *                     ogle.com/recommendation/datafeeds/default_catalog/dashboard
