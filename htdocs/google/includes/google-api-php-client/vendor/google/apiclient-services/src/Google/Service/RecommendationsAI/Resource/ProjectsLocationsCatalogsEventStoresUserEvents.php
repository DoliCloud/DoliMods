...
class Google_Service_RecommendationsAI_Resource_ProjectsLocationsCatalogsEventStoresUserEvents extends Google_Service_Resource
{
	 ...
	 * to browser restriction of POST-ing to a 3rd party domain.
	 *
	 * This method is used only by the Recommendations AI JavaScript pixel. Users
	 * should not call this method directly. (userEvents.collect)
	 *
	 ...
	 * subset of the items to be successfully inserted. Operation.metadata is of
	 * type ImportMetadata. (userEvents.import)
	 *
	 ...
	 * ingested event is not in the current catalog, it could lead to degraded model
	 * quality. This is called an unjoined event.
	 * (userEvents.listProjectsLocationsCatalogsEventStoresUserEvents)
	 *
	 ...
	 * restrict should result in one contiguous valid eventTime      range.
	 *
	 *    * eventType: only 1 eventType restriction can be specified.
	 *
	 *    * eventsMissingCatalogItems: specififying this will restrict results
	 * to events for which catalog items were not found in the catalog. The
	 * default behavior is to return only those events for which catalog      items
	 * were found.
	 *
