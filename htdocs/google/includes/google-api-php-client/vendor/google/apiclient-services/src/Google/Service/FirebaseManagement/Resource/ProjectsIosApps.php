...
class Google_Service_FirebaseManagement_Resource_ProjectsIosApps extends Google_Service_Resource
{
   ...
   *
   * Refer to the `IosApp` [`name`](../projects.iosApps#IosApp.FIELDS.name) field
   ...
   * in the format: projects/PROJECT_IDENTIFIER/iosApps/APP_ID/config
   *
   * Since an APP_ID is a unique identifier, the Unique Resource from Sub-
   * Collection access pattern may be used here, in the format:
   * projects/-/iosApps/APP_ID
   ...
   *
   * Note that the fields `name`, `appId`, `projectId`, and `bundleId` are all
   * immutable.
   * @return Google_Service_FirebaseManagement_IosApp
   */
