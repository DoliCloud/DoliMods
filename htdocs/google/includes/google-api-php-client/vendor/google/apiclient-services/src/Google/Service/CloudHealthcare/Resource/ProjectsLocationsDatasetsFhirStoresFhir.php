...
class Google_Service_CloudHealthcare_Resource_ProjectsLocationsDatasetsFhirStoresFhir extends Google_Service_Resource
{
	 ...
	 * patient compartment resources](/healthcare/docs/how-tos/fhir-
	 ...
	 * provided, only resources of the specified resource type(s) will be returned.
	 ...
	 *
	 * For samples that show how to call `Resource-purge`, see [Deleting historical
	 * versions of a FHIR resource](/healthcare/docs/how-tos/fhir-
	 ...
	 *
	 * For samples that show how to call `create`, see [Creating a FHIR
	 ...
	 * versions](/healthcare/docs/how-tos/fhir-
