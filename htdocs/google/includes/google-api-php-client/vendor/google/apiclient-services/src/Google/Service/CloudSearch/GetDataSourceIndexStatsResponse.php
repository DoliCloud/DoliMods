...
class Google_Service_CloudSearch_GetDataSourceIndexStatsResponse extends Google_Collection
{
	protected $collection_key = 'stats';
	protected $statsType = 'Google_Service_CloudSearch_DataSourceIndexStats';
