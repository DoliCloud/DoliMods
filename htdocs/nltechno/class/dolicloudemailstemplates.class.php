...
/**
 *  \file       dev/skeletons/dolicloudemailstemplates.class.php
 ...
 */
class Dolicloudemailstemplates // extends CommonObject
{
	var $db;							//!< To store db handler
	var $error;							//!< To return error code (or message)
	var $errors=array();				//!< To return several error codes (or messages)
	//var $element='dolicloudemailstemplates';			//!< Id that identify managed objects
    ...
    function create($user, $notrigger=0)
    {
		...
		if (! $error)
        {
            $this->id = $this->db->last_insert_id(MAIN_DB_PREFIX."dolicloud_emailstemplates");
	...
	function delete($user, $notrigger=0)
	{
		...
		if (! $error)
		{
    		$sql = "DELETE FROM ".MAIN_DB_PREFIX."dolicloud_emailstemplates";
    		$sql.= " WHERE rowid=".$this->id;
	...
	function createFromClone($fromid)
	{
		...
		$object=new Dolicloudemailstemplates($this->db);
