...
/**
 *      \defgroup   multiinstance     Module multiinstance
 *      \brief      Descriptor file for module multiinstance
 *      \file       htdocs/core/modules/modMultiInstance.class.php
 *      \ingroup    multiinstance
 *      \brief      Description and activation file for module MultiInstance
 */
include_once(DOL_DOCUMENT_ROOT ."/core/modules/DolibarrModules.class.php");


/**
 *	Description and activation class for module MultiInstance
 */
class modMultiInstance extends DolibarrModules
{
	/**
	 *  Constructor.
	 *
	...
	function __construct($db)
	{
		...
		$this->rights_class = 'multiinstance';
		...
		$this->picto='multiinstance@multiinstance';

		// Data directories to create when module is enabled.
		$this->dirs = array();

		// Config pages. Put here list of php page names stored in admmin directory used to setup module.
		$this->config_page_url = array("multiinstance.php@multiinstance");
		...
		$this->module_parts = array(
				...
				'css' => array(
						'/multiinstance/css/multiinstance.css.php'
				)
		);
		...
		$this->langfiles = array("multiinstance@multiinstance");
	...
	{
		return $this->_load_tables('/multiinstance/sql/');
	}
