...
$contextpage=GETPOST('contextpage','aZ')?GETPOST('contextpage','aZ'):'productcataloglist';

// Initialize technical object to manage hooks. Note that conf->hooks_modules contains array
$hookmanager->initHooks(array('productcataloglist'));
$extrafields = new ExtraFields($db);

// fetch optionals attributes and labels
$extralabels = $extrafields->fetch_name_optionals_label('productcatalog');
...
$help_url='';
$title = $langs->trans('ProductCatalogListTitle');
...
if ($user->rights->productcatalog->supprimer) $arrayofmassactions['delete']=$langs->trans("Delete");
...
if ($massaction == 'builddoc' || $action == 'remove_file' || $show_files)
{
    ...
    print $formfile->showdocuments('massfilesarea_productcatalog','',$filedir,$urlsource,0,$delallowed,'',1,1,0,48,1,$param,$title,'');
}
else
{
