...
/**
 * \file    test/functional/ProductCatalogFunctionalTest.php
...
/**
 * Class ProductCatalogFunctionalTest
 *
 ...
 *
 * @package Testproductcatalog
 */
class ProductCatalogFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
...
//        )
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modProductCatalog')->click();
		} else {
			// Disable the module
			$this->byHref('modProductCatalog')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/productcatalog/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('productcatalog/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/productcatalog/admin/about.php');
		$this->authenticate();
		return $this->assertContains('productcatalog/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modProductCatalog_MyTrigger.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modProductCatalog_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
