...
/**
 * \file    core/triggers/interface_99_modProductCatalog_ProductCatalogTriggers.class.php
...
/**
 *  Class of triggers for ProductCatalog module
 */
class InterfaceProductCatalogTriggers extends DolibarrTriggers
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->family = "demo";
		$this->description = "ProductCatalog triggers.";
		// 'development', 'experimental', 'dolibarr' or version
		$this->version = 'development';
		$this->picto = 'productcatalog@productcatalog';
	}
