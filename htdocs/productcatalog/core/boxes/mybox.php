...
class MyBox extends ModeleBoxes
{
	 ...
	 */
	public $boximg = "productcatalog@productcatalog";
	 ...
	 */
	public $depends = array('productcatalog');
	...
	public function loadBox($max = 5)
	{
		...
		//include_once DOL_DOCUMENT_ROOT . "/productcatalog/class/productcatalog.class.php";
		...
		$this->info_box_head = array(
			...
			'subpicto' => 'object_productcatalog@productcatalog',
		...
		$this->info_box_contents = array(
			0 => array( // First line
				0 => array( // First Column
					...
					'td'           => '',
					// Fist line logo
					'logo'         => 'productcatalog@productcatalog',
					// Main text
					'text'         => 'My text',
					// Secondary text
