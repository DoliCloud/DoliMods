 ...
 *		\version	$Id: modVoyage.class.php,v 1.1 2009/09/29 17:45:27 eldy Exp $
 */
...
class modVoyage extends DolibarrModules
{
	...
	function modVoyage($DB)
	{
		...
		$this->description = "Module Voyage";
	...
	{
		return $this->_load_tables('/voyage/sql/');
	}
}
