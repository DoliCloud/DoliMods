...
class mailing_mailinglist_chatsderace extends MailingTargets
{
	...
	*/
	function getNbOfRecipients()
	{
		...
		$a=parent::getNbOfRecipients("select count(*) as nb from chatsderace_db.T_PERSONNES where EMAIL_PERSO IS NOT NULL AND EMAIL_PERSO != '' and ML_PERSO = 1");
		$b=parent::getNbOfRecipients("select count(*) as nb from chatsderace_db.T_ADRESSES  where EMAIL_ADRES IS NOT NULL AND EMAIL_ADRES != '' and ML_ADRES = 1");
		return ($a+$b);
	}
