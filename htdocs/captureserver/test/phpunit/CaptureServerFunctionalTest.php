...
/**
 * \file    test/functional/CaptureServerFunctionalTest.php
...
/**
 * Class CaptureServerFunctionalTest
 *
 ...
 *
 * @package Testcaptureserver
 */
class CaptureServerFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
...
//        )
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modCaptureServer')->click();
		} else {
			// Disable the module
			$this->byHref('modCaptureServer')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/captureserver/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('captureserver/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/captureserver/admin/about.php');
		$this->authenticate();
		return $this->assertContains('captureserver/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('captureserverwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modCaptureServer_CaptureServerTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modCaptureServer_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
