...
/**
 * 	\defgroup   captureserver     Module CaptureServer
 *  \brief      CaptureServer module descriptor.
 *
 *  \file       htdocs/captureserver/core/modules/modCaptureServer.class.php
 *  \ingroup    captureserver
 *  \brief      Description and activation file for module CaptureServer
 */
include_once DOL_DOCUMENT_ROOT .'/core/modules/DolibarrModules.class.php';


/**
 *  Description and activation class for module CaptureServer
 */
class modCaptureServer extends DolibarrModules
{
	/**
	...
	public function __construct($db)
	{
		...
		// Module label (no space allowed), used if translation string 'ModuleCaptureServerName' not found (CaptureServer is name of module).
		$this->name = preg_replace('/^mod/i', '', get_class($this));
		// Module description, used if translation string 'ModuleCaptureServerDesc' not found (CaptureServer is name of module).
		$this->description = "CaptureServerDescription";
		...
		// Example: this->dirs = array("/captureserver/temp","/captureserver/subdir");
		$this->dirs = array("/captureserver/temp");

		// Config pages. Put here list of php page, stored into captureserver/admin directory, to use to setup module.
		$this->config_page_url = array("setup.php@captureserver");
		...
		$this->langfiles = array("captureserver@captureserver");
		$this->phpmin = array(5,4);					// Minimum version of PHP required by module
		$this->need_dolibarr_version = array(4,0);	// Minimum version of Dolibarr required by module
		$this->warnings_activation = array();                     // Warning to show when we activate module. array('always'='text') or array('FR'='textfr','ES'='textes'...)
		$this->warnings_activation_ext = array();                 // Warning to show when we activate an external module. array('always'='text') or array('FR'='textfr','ES'='textes'...)
		//$this->automatic_activation = array('FR'=>'CaptureServerWasAutomaticallyActivatedBecauseOfYourCountryChoice');
		//$this->always_enabled = true;								// If true, can't be disabled

		// Constants
		// List of particular constants to add when module is enabled (key, 'chaine', value, desc, visible, 'current' or 'allentities', deleteonunactive)
		// Example: $this->const=array(0=>array('CAPTURESERVER_MYNEWCONST1','chaine','myvalue','This is a constant to add',1),
		//                             1=>array('CAPTURESERVER_MYNEWCONST2','chaine','myvalue','This is another constant to add',0, 'current', 1)
		// );
		$this->const = array(
			1=>array('CAPTURESERVER_MYCONSTANT', 'chaine', 'avalue', 'This is a constant to add', 1, 'allentities', 1)
		);
		...
		if (! isset($conf->captureserver) || ! isset($conf->captureserver->enabled)) {
			$conf->captureserver=new stdClass();
			$conf->captureserver->enabled=0;
		}
		...
		$this->tabs = array();
		// Example:
		// $this->tabs[] = array('data'=>'objecttype:+tabname1:Title1:mylangfile@captureserver:$user->rights->captureserver->read:/captureserver/mynewtab1.php?id=__ID__');  					// To add a new tab identified by code tabname1
		// $this->tabs[] = array('data'=>'objecttype:+tabname2:SUBSTITUTION_Title2:mylangfile@captureserver:$user->rights->othermodule->read:/captureserver/mynewtab2.php?id=__ID__',  	// To add another new tab identified by code tabname2. Label will be result of calling all substitution functions on 'Title2' key.
		...
		$this->dictionaries=array(
			...
			'tabcond'=>array($conf->captureserver->enabled,$conf->captureserver->enabled,$conf->captureserver->enabled)												// Condition to show each dictionary
		);
		*/
		...
		/*$this->menu[$r++]=array('fk_menu'=>'',			                // '' if this is a top menu. For left menu, use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
								...
								'leftmenu'=>'',
								'url'=>'/captureserver/captureserverindex.php',
								'langs'=>'captureserver@captureserver',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
								'position'=>1000+$r,
								'enabled'=>'$conf->captureserver->enabled',	// Define condition to show or hide menu entry. Use '$conf->captureserver->enabled' if entry must be visible if module is enabled.
		...
		*/
		...
		/*$this->menu[$r++]=array(	'fk_menu'=>'fk_mainmenu=captureserver,fk_leftmenu=captureserver',	    // '' if this is a top menu. For left menu, use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
								...
								'titre'=>'New MyObject',
								'mainmenu'=>'captureserver',
								'leftmenu'=>'captureserver_myobject_new',
								'url'=>'/captureserver/myobject_page.php?action=create',
								'langs'=>'captureserver@captureserver',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
								'position'=>1000+$r,
								'enabled'=>'$conf->captureserver->enabled',  // Define condition to show or hide menu entry. Use '$conf->captureserver->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
								'perms'=>'1',			                // Use 'perms'=>'$user->rights->captureserver->level1->level2' if you want your menu with a permission rules
		...
		$this->export_icon[$r]='myobject@captureserver';
	...
	{
		$result=$this->_load_tables('/captureserver/sql/');
		...
		//$result3=$extrafields->addExtraField('myattr3', "New Attr 3 label", 'varchar', 1, 10, 'bank_account', 0, 0, '', '', 1, '', 0, 0, '', '', 'captureserver@captureserver', '$conf->captureserver->enabled');
		//$result4=$extrafields->addExtraField('myattr4', "New Attr 4 label", 'select',  1,  3, 'thirdparty',   0, 1, '', array('options'=>array('code1'=>'Val1','code2'=>'Val2','code3'=>'Val3')), 1 '', 0, 0, '', '', 'captureserver@captureserver', '$conf->captureserver->enabled');
		//$result5=$extrafields->addExtraField('myattr5', "New Attr 5 label", 'text',    1, 10, 'user',         0, 0, '', '', 1, '', 0, 0, '', '', 'captureserver@captureserver', '$conf->captureserver->enabled');
