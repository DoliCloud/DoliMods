...
dol_include_once("/captureserver/class/myobject.class.php");


/**
 * mailing_mailinglist_captureserver
 */
class mailing_mailinglist_captureserver_myobject extends MailingTargets
{
	// CHANGE THIS: Put here a name not already used
	var $name='mailinglist_captureserver_myobject';
	...
	var $picto='captureserver@captureserver';
	...
	function __construct($db)
	{
		...
		{
			$this->enabled=in_array('captureserver',$conf->modules)?1:0;
		}
	}
	...
	function url($id)
	{
		return '<a href="'.dol_buildpath('/captureserver/myobject_card.php',1).'?id='.$id.'">'.img_object('',"generic").'</a>';
	}
	...
	function add_to_target($mailing_id,$filtersarray=array())
	{
		...
		if ($result)
		{
			...
			dol_syslog("mailinglist_captureserver_myobject.modules.php: mailing ".$num." targets found");
