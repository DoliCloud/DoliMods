...
/**
 * \file    modulebuilder/template/core/boxes/captureserverwidget1.php
 * \ingroup captureserver
 * \brief   Widget provided by CaptureServer
 *
 ...
 */
class captureserverwidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "captureserverbox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "captureserver@captureserver";
	 ...
	 */
	public $depends = array('captureserver');
	...
	public function loadBox($max = 5)
	{
		...
		//include_once DOL_DOCUMENT_ROOT . "/captureserver/class/captureserver.class.php";

		// Populate the head at runtime
		$text = $langs->trans("CaptureServerBoxDescription", $max);
		$this->info_box_head = array(
			...
			'subpicto' => 'object_captureserver@captureserver',
