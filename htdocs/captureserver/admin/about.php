...
/**
 *	    \file       htdocs/captureserver/admin/about.php
...
dol_fiche_head($head, 'about', '', -1, "captureserver@captureserver");


dol_include_once('/captureserver/core/modules/modCaptureServer.class.php');
