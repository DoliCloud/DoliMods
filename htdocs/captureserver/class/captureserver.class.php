...
class CaptureServer extends CommonObject
{
	...
	public $fields=array(
	    ...
	    'label' => array('type'=>'varchar(255)', 'label'=>'Label', 'enabled'=>1, 'visible'=>1, 'position'=>32, 'notnull'=>-1, 'searchall'=>1, 'help'=>"Label", 'cssview'=>'wordbreak'),
	...
	public function getLinesArray()
	{
	    ...
	    $result = $objectline->fetchAll('ASC', 'position', 0, 0, array('customsql'=>'fk_captureserver = '.$this->id));
