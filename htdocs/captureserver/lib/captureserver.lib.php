...
/**
 * \file    captureserver/lib/captureserver.lib.php
...
function captureserverAdminPrepareHead()
{
	...
	$head[$h][0] = dol_buildpath("/captureserver/admin/setup.php", 1);
	$head[$h][1] = $langs->trans("Settings");
	$head[$h][2] = 'settings';
	$h++;
	$head[$h][0] = dol_buildpath("/captureserver/admin/about.php", 1);
