...
$langs->loadLangs(array("captureserver@captureserver"));
...
llxHeader("", $langs->trans("CaptureServerArea"));

print load_fiche_titre($langs->trans("CaptureServerArea"), '', 'captureserver.png@captureserver');
