...
/**
 *  \file       packages_document.php
 *  \ingroup    sellyoursaas
 *  \brief      Tab for documents linked to Packages
 */
...
$langs->loadLangs(array("sellyoursaas@sellyoursaas","companies","other"));
...
$hookmanager->initHooks(array('packagesdocument'));     // Note that conf->hooks_modules contains array
...
$title=$langs->trans("Packages").' - '.$langs->trans("Files");
$help_url='';
