...
Suite au déploiement de la v1, la plateforme évolua pour ajouter d'autres objectifs :
	...
	* Prendre en compte la souscription et les abonnements payants à l'application proposée.
	* Espace client dédié 
...
SellYourSaas v2 a atteint ces objectifs et est aujourd'hui en production chez plusieurs sociétés proposants des services Saas (DoliCloud, NovaFirstCloud, GLPI-Network, ...). Voici un synthèse de ces capacités:
    ...
    * Déploiment de n'importe quelle application WAMP.
    * Espace client dédié.
    ...
    * Coût d'infrastructure par instance < 20 centimes.
    * ... 
     

Le projet est disponible de manière communautaire depuis 2020 sur GitHub: https://github.com/eldy/sellyoursaas
Il est composé:
    * D'un module extension à l'excellent ERP CRM Open Source Dolibarr.
