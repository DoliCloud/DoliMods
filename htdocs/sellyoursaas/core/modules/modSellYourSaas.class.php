...
class modSellYourSaas extends DolibarrModules
{
	...
	function init($options='')
	{
		...
		// Thirdparty
		$resultx=$extrafields->addExtraField('separatorthirdparty',       "SELLYOURSAAS_NAME", 'separate',  100,    '','thirdparty', 0, 1,   '',    '1', 1, '',  1, 0, '', '', 'sellyoursaas@sellyoursaas', '$conf->sellyoursaas->enabled');
		$arrayoptions=array(
		    'no'=>'No',
		    //'yesv1'=>'Yes (v1)',
		    'yesv2'=>'Yes'
		...
		$resultx=$extrafields->addExtraField('stripeaccount',                       "StripeAccount",  'varchar',197, '255', 'thirdparty', 0, 0, '',     '', 1, '', -1, 0, '', '', 'sellyoursaas@sellyoursaas', '$conf->sellyoursaas->enabled', 'Example: pk_live_1234567:sk_live_1234567');
