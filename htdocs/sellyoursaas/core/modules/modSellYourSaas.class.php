...
class modSellYourSaas extends DolibarrModules
{
	...
	function init($options='')
	{
		...
		$resultx=$extrafields->addExtraField('custom_virtualhostline',      "CustomVirtualHostLine",  'varchar', 119, '255',    'contrat', 0, 0,    '',      '', 1, '', -1, 0, 'Enter a line to add into the web server virtualhost. For example:<br>php_value date.timezone "Europe/Paris"', '', 'sellyoursaas@sellyoursaas', '$conf->sellyoursaas->enabled');
