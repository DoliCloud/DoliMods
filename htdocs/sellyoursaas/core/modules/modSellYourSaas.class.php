...
class modSellYourSaas extends DolibarrModules
{
	...
	function __construct($db)
	{
		...
		$statusatinstall=0;
		$this->cronjobs = array(
			0=>array('label'=>'SendWelcomeMessage',                'jobtype'=>'method', 'class'=>'/sellyoursaas/class/sellyoursaasutils.class.php', 'objectname'=>'SellYourSaas', 'method'=>'doSendWelcomeMessage',                'parameters'=>'', 'comment'=>'Suspend expired services', 'frequency'=>1, 'unitfrequency'=>86400, 'status'=>$statusatinstall, 'test'=>'$conf->sellyoursaas->enabled'),
			1=>array('label'=>'AlertSoftEndTrial',                 'jobtype'=>'method', 'class'=>'/sellyoursaas/class/sellyoursaasutils.class.php', 'objectname'=>'SellYourSaas', 'method'=>'doAlertSoftEndTrial',                 'parameters'=>'', 'comment'=>'Suspend expired services', 'frequency'=>1, 'unitfrequency'=>86400, 'status'=>$statusatinstall, 'test'=>'$conf->sellyoursaas->enabled'),
			2=>array('label'=>'SuspendNotPaidTestInstances',       'jobtype'=>'method', 'class'=>'/sellyoursaas/class/sellyoursaasutils.class.php', 'objectname'=>'SellYourSaas', 'method'=>'doSuspendNotPaidTestInstances',       'parameters'=>'', 'comment'=>'Suspend expired services', 'frequency'=>1, 'unitfrequency'=>86400, 'status'=>$statusatinstall, 'test'=>'$conf->sellyoursaas->enabled'),
			3=>array('label'=>'UndeployOldSuspendedTestInstances', 'jobtype'=>'method', 'class'=>'/sellyoursaas/class/sellyoursaasutils.class.php', 'objectname'=>'SellYourSaas', 'method'=>'doUndeployOldSuspendedTestInstances', 'parameters'=>'', 'comment'=>'Suspend expired services', 'frequency'=>1, 'unitfrequency'=>86400, 'status'=>$statusatinstall, 'test'=>'$conf->sellyoursaas->enabled'),
			4=>array('label'=>'TakePaymentPaypal',                 'jobtype'=>'method', 'class'=>'/sellyoursaas/class/sellyoursaasutils.class.php', 'objectname'=>'SellYourSaas', 'method'=>'doTakePaymentPaypal',                 'parameters'=>'', 'comment'=>'Suspend expired services', 'frequency'=>1, 'unitfrequency'=>86400, 'status'=>$statusatinstall, 'test'=>'$conf->sellyoursaas->enabled'),
			5=>array('label'=>'TakePaymentStripe',                 'jobtype'=>'method', 'class'=>'/sellyoursaas/class/sellyoursaasutils.class.php', 'objectname'=>'SellYourSaas', 'method'=>'doTakePaymentStripe',                 'parameters'=>'', 'comment'=>'Suspend expired services', 'frequency'=>1, 'unitfrequency'=>86400, 'status'=>$statusatinstall, 'test'=>'$conf->sellyoursaas->enabled'),
			6=>array('label'=>'SuspendNotPaidRealInstances',       'jobtype'=>'method', 'class'=>'/sellyoursaas/class/sellyoursaasutils.class.php', 'objectname'=>'SellYourSaas', 'method'=>'doSuspendNotPaidRealInstances',       'parameters'=>'', 'comment'=>'Suspend expired services', 'frequency'=>1, 'unitfrequency'=>86400, 'status'=>$statusatinstall, 'test'=>'$conf->sellyoursaas->enabled'),
			7=>array('label'=>'AlertCreditCardExpiration',         'jobtype'=>'method', 'class'=>'/sellyoursaas/class/sellyoursaasutils.class.php', 'objectname'=>'SellYourSaas', 'method'=>'doAlertCreditCardExpiration',         'parameters'=>'', 'comment'=>'Suspend expired services', 'frequency'=>1, 'unitfrequency'=>86400, 'status'=>$statusatinstall, 'test'=>'$conf->sellyoursaas->enabled'),
			8=>array('label'=>'AlertPaypalExpiration',             'jobtype'=>'method', 'class'=>'/sellyoursaas/class/sellyoursaasutils.class.php', 'objectname'=>'SellYourSaas', 'method'=>'AdolertPaypalExpiration',             'parameters'=>'', 'comment'=>'Suspend expired services', 'frequency'=>1, 'unitfrequency'=>86400, 'status'=>$statusatinstall, 'test'=>'$conf->sellyoursaas->enabled'),
		);
        ...
        */
		...
		$this->menu[$r]=array(	'fk_menu'=>0,
								...
								'perms'=>'$user->rights->sellyoursaas->liens->voir||$user->rights->sellyoursaas->annonces->voir||$user->rights->sellyoursaas->emailings->voir',
								'target'=>'',
								'user'=>0);
		$r++;
		...
		$this->menu[$r]=array(
		    ...
		    'position'=>200,
		    'enabled'=>'$conf->sellyoursaas->enabled',         // Define condition to show or hide menu entry. Use '$conf->NewsSubmitter->enabled' if entry must be visible if module is enabled.
		    'perms'=>'$user->rights->sellyoursaas->dolicloud->read',           // Use 'perms'=>'$user->rights->NewsSubmitter->level1->level2' if you want your menu with a permission rules
		    'target'=>'',
		...
		$this->menu[$r]=array(
		    ...
		    'position'=>210,
		    'enabled'=>'$conf->sellyoursaas->enabled',         // Define condition to show or hide menu entry. Use '$conf->NewsSubmitter->enabled' if entry must be visible if module is enabled.
		    'perms'=>'$user->rights->sellyoursaas->dolicloud->read',
		    'target'=>'',
		    'user'=>0);
		$r++;
		...
		/*
		 ...
		 'position'=>210,
		 'enabled'=>'$conf->sellyoursaas->enabled',         // Define condition to show or hide menu entry. Use '$conf->NewsSubmitter->enabled' if entry must be visible if module is enabled.
		 'perms'=>'$user->rights->sellyoursaas->dolicloud->write',
		 'target'=>'',
		 'user'=>0);
		 $r++;
...
/*
		...
		$this->menu[$r]=array(
		    ...
		    'position'=>400,
		    'enabled'=>'$conf->sellyoursaas->enabled',         // Define condition to show or hide menu entry. Use '$conf->NewsSubmitter->enabled' if entry must be visible if module is enabled.
		    'perms'=>'$user->rights->sellyoursaas->annonces->voir',
		    'target'=>'',
		    'user'=>0);
		$r++;
		...
		$this->menu[$r]=array(
		    ...
		    'position'=>500,
		    'enabled'=>'$conf->sellyoursaas->enabled',         // Define condition to show or hide menu entry. Use '$conf->NewsSubmitter->enabled' if entry must be visible if module is enabled.
		    'perms'=>'$user->rights->sellyoursaas->emailings->voir',
		    'target'=>'',
		    'user'=>0);
		$r++;
        */
