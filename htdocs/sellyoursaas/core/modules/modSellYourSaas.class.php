...
class modSellYourSaas extends DolibarrModules
{
	...
	function __construct($db)
	{
		...
		$this->cronjobs = array(
			...
			4=>array('priority'=>71, 'label'=>'SellYourSaasRenewalContracts',                  'jobtype'=>'method', 'class'=>'/sellyoursaas/class/sellyoursaasutils.class.php', 'objectname'=>'SellYourSaasUtils', 'method'=>'doRenewalContracts',                  'parameters'=>'', 'comment'=>'Update planned end date of service of contracts (lines of users and amount) when service is on and planned end date <= tomorrow', 'frequency'=>1, 'unitfrequency'=>86400, 'status'=>$statusatinstall, 'test'=>'$conf->sellyoursaas->enabled'),
	...
	function init($options='')
	{
		...
		// Product
		$resultx=$extrafields->addExtraField('separatorproduct',                       "SaaS",'separate',   100,     '',  'product', 0, 1, '',       '', 1, '',  1, 0, '', '', 'sellyoursaas@sellyoursaas', '$conf->sellyoursaas->enabled');
		...
		$resultx=$extrafields->addExtraField('partner',                       "Reseller",  'varchar',103,  '32', 'thirdparty', 0, 0, '',     '', 1, '', 1, 0, '', '', 'sellyoursaas@sellyoursaas', '$conf->sellyoursaas->enabled');
