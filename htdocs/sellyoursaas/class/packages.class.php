...
class Packages extends CommonObject
{
	...
	public $fields=array(
		...
		'crontoadd' => array('type'=>'text', 'label'=>'Template of cron file', 'visible'=>-1, 'enabled'=>1, 'position'=>60, 'notnull'=>-1, 'help'=>'Content will be used to add a file into /var/spool/cron/crontabs'),
	    ...
	    'allowoverride' => array('type'=>'varchar(255)', 'label'=>'String for AllowOverride', 'visible'=>-1, 'enabled'=>1, 'position'=>75, 'notnull'=>-1, 'help'=>'Keep empty to not allow apache override<br>Use "AllowOverride All" to allow override.'),
