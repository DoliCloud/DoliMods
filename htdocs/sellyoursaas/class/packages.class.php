...
class Packages extends CommonObject
{
	...
	public $fields=array(
	    ...
	    'allowoverride' => array('type'=>'text', 'label'=>'String for AllowOverride', 'visible'=>-1, 'enabled'=>1, 'position'=>75, 'notnull'=>-1, 'help'=>'Keep empty to not allow apache override<br>Use "AllowOverride All" to allow override.'),
