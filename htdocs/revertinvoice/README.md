# REVERTINVOICE FOR <a href="https://www.dolibarr.org">DOLIBARR ERP CRM</a>
...
- Clone the repository in ```$dolibarr_main_document_root_alt/revertinvoice```

```sh
cd ....../custom
git clone git@github.com:gitlogin/revertinvoice.git revertinvoice
```
