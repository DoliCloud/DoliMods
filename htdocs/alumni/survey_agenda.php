...
/**
 *  \file       survey_agenda.php
 *  \ingroup    alumni
 *  \brief      Tab of events on Survey
 */
...
if ($id > 0 || !empty($ref)) {
	$upload_dir = $conf->alumni->multidir_output[!empty($object->entity) ? $object->entity : $conf->entity]."/".$object->id;
}
...
if ($object->id > 0) {
	$title = $langs->trans("Survey")." - ".$langs->trans('Agenda');
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("Survey"), -1, $object->picto);
