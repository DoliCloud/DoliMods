...
class Survey extends CommonObject
{
	...
	public $fields=array(
		...
		"activiteassocieesnat" => array("type"=>"varchar(128)", "label"=>"ActiviteAssocieesNature", "enabled"=>"isModEnabled('alumni')", 'position'=>61, 'notnull'=>0, "visible"=>"1", "csslist"=>"tdoverflowmax150", "arrayofkeyval"=>array("musee" => "Musée", "visiteusine" => "Visite usine", "baladenature" => "Balade nature", "autre" => "Autre")),
