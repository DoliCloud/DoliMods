...
class Survey extends CommonObject
{
	...
	public $fields=array(
		...
		"lieu" => array("type"=>"varchar(24)", "label"=>"Lieu", "enabled"=>"isModEnabled('alumni')", 'position'=>70, 'notnull'=>0, "visible"=>"-1", "arrayofkeyval"=>array("lilleuniquement" => "Lille uniquement", "parisuniquement" => "Paris uniquement", "lilleparis" => "Lille sinon Paris", "parislille" => "Paris sinon Lille", "peuimporte" => "Peu importe")),
