...
/**
 *	\file       alumni/alumniindex.php
 *	\ingroup    alumni
 *	\brief      Home page of alumni top menu
 */
...
$langs->loadLangs(array("alumni@alumni"));
...
//}
//if (! $user->hasRight('alumni', 'myobject', 'read')) {
//	accessforbidden();
//}
//restrictedArea($user, 'alumni', 0, 'alumni_myobject', 'myobject', '', 'rowid');
//if (empty($user->admin)) {
...
if (isModEnabled('alumni') && $user->rights->alumni->read)
{
	...
	$sql.= " FROM ".MAIN_DB_PREFIX."alumni_myobject as s";
