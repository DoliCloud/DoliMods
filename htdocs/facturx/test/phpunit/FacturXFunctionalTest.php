...
/**
 * \file    test/functional/FacturXFunctionalTest.php
 * \ingroup facturx
 ...
 * @package Testfacturx
 */
class FacturXFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
...
//        )
	...
	{
		$this->url('/custom/facturx/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('facturx/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/facturx/admin/about.php');
		$this->authenticate();
		return $this->assertContains('facturx/admin/about.php', $this->url(), 'About page');
	}
...
return $this->assertEquals(
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('facturxwidget1', $this->source(), "Box enabled");
	}
...
return $this->assertContains(
			'interface_99_modFacturX_FacturXTriggers.class.php',
...
return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modFacturX_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
