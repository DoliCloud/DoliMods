...
dol_include_once('/facturx/class/myobject.class.php');



/**
 * \file    facturx/class/api_facturx.class.php
 * \ingroup facturx
 * \brief   File for API management of myobject.
 */

/**
 * API class for facturx myobject
 *
 * @smart-auto-routing false
 * @access protected
 * @class  DolibarrApiAccess {@requires user,external}
 */
class FacturXApi extends DolibarrApi
{
    /**
