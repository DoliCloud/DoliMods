...
class modFacturX extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		// Key used in llx_const table to save module status enabled/disabled (where FACTURX is value of property name of module in uppercase)
		...
		$this->module_parts = array(
			...
			'css' => array('/facturx/css/facturx.css.php'),	// Set this to relative path of css file if module has its own css file
	 		'js' => array('/facturx/js/facturx.js.php'),          // Set this to relative path of js file if module must load a js on all pages
		...
		// Example: $this->const=array(0=>array('FACTURX_MYNEWCONST1','chaine','myvalue','This is a constant to add',1),
		//                             1=>array('FACTURX_MYNEWCONST2','chaine','myvalue','This is another constant to add',0, 'current', 1)
		// );
		$this->const = array(
			1=>array('FACTURX_MYCONSTANT', 'chaine', 'avalue', 'This is a constant to add', 1, 'allentities', 1)
		);
