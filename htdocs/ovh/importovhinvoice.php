            ...
            foreach ($listofref as $key => $val) {
                ...
                if ($facid > 0) {
                    if (!empty($conf->global->OVH_OLDAPI)) {
                        ...
                        if (round($facfou->total_ttc, 2) != round($r['totalPriceWithVat'],
                                2) or round($facfou->total_tva, 2) != round($r['vat'], 2)) {
                            ...
                            if (round($facfou->total_ttc, 2) != round($r['totalPriceWithVat'],
                                ...
                                if (round($facfou->total_ttc, 2) != round($r['totalPriceWithVat'],
                                    ...
                                    setEventMessage("ALERT: Le montant de la facture {$facfou->libelle} n'est pas conforme.",
                                        'warnings');
                                }
                            }
                        }
