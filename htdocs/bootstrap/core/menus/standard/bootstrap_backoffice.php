...
class MenuTop
{
	...
	function showmenu()
	{
		dol_include_once("/bootstrap/core/menus/standard/bootstrap.lib.php");

		print_bootstrap_menu($this->db,$this->atarget,$this->hideifnotallowed);
	}
...
class MenuLeft
{
    ...
    function showmenu()
    {
        ...
        $res=print_left_bootstrap_menu($this->db,$this->menu_array,$this->menu_array_after);
